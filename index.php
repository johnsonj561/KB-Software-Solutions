...
<h2 class="mobile-only">CLICK TO CALL NOW</h2></a>
            ...
            <div class="carousel-inner">
              ...
              <div class="item">
                <img class="img-responsive img-full" src="img/lilly-pad-home-page-900x500.jpg" 
                     alt="Contact for website estimates"><
              </div>
                <div class="item">
          ...
          <div class="col-md-5">
            ...
            <p>KB Software Solutions delivers custom web designs to local businesses for affordable
              costs. Get your new business online or restore an existing design and attract new customers.</p>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <!--      <div class="text-center"><a class="btn btn-default text-center" href="#">More Info</a></div> -->
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <!--  <div class="text-center"><a class="btn btn-default" href="#">More Info</a></div> -->
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="col-lg-6">
                ...
                <p class="pull-right">
                  <a href="http://www.kbsoftwaresolutions.com"><img src="img/kb-logo-150x75.png" alt="KB Software Solutions Logo"/></a>
                </p>
              </div>
            </div>
          </div>
